                        ...
                        <div class="col-sm-4">
                            <div class="single-item">
                                <div class="single-item-header">
                                    <a href="{{ route('product.show', ['categorySlug' => $rp->category->slug, 'productSlug' => $rp->slug]) }}">
                                        <img alt="" height="150px" src="{{Config::get('headphone.products', '/images/products/')}}{{ $rp->image['main']}}"/>
                                    </a>
                                </div>
                                <div class="single-item-body">
                                    <p class="single-item-title">
                                    ...
                                    <p class="single-item-price" style="font-size: 18px">
                                        <span class="flash-sale">
                                            {{number_format($rp->price)}} đồng
                                        </span>
                                    </p>
                                </div>
                                <div class="single-item-caption">
                                    <a class="add-to-cart pull-left" href="{{ route('cart.quick-add',$rp->slug) }}">
                                        <i class="fa fa-shopping-cart">
                                        </i>
                                    </a>
                                    <a class="beta-btn primary" href="{{ route('product.show', ['categorySlug' => $rp->category->slug, 'productSlug' => $rp->slug]) }}">
                                        Details
