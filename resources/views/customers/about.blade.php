...
<<<<<<< e34321ac32204ec884ca80e15a50bffd82a8e5b5
    <div class="container">
        <div class="pull-left">
...
<div class="container">
    <div id="content">
        <div class="our-history">
            ...
            <div class="history-slider">
                <div class="history-navigation">
                    <a class="circle" data-slide-index="0" href="blog_with_2sidebars_type_e.html">
                        <span class="auto-center">
                            2003
                        </span>
                    </a>
                    <a class="circle" data-slide-index="1" href="blog_with_2sidebars_type_e.html">
                        <span class="auto-center">
                            2004
                        </span>
                    </a>
                    <a class="circle" data-slide-index="2" href="blog_with_2sidebars_type_e.html">
                        <span class="auto-center">
                            2005
                        </span>
                    </a>
                    <a class="circle" data-slide-index="3" href="blog_with_2sidebars_type_e.html">
                        <span class="auto-center">
                            2007
                        </span>
                    </a>
                    <a class="circle" data-slide-index="4" href="blog_with_2sidebars_type_e.html">
                        <span class="auto-center">
                            2009
                        </span>
                    </a>
                    <a class="circle" data-slide-index="5" href="blog_with_2sidebars_type_e.html">
                        <span class="auto-center">
                            2011
                        </span>
                    </a>
                    <a class="circle" data-slide-index="6" href="blog_with_2sidebars_type_e.html">
                        <span class="auto-center">
                            2014
                        </span>
                    </a>
                ...
                <div class="history-slides">
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img alt="" src="source/assets/dest/images/history.jpg">
                                </img>
                            </div>
                            <div class="col-sm-7">
        ...
        <div class="row">
            <div class="col-sm-2 col-sm-push-2">
                <div class="beta-counter">
                    ...
                    <p class="beta-counter-value timer numbers" data-speed="2000" data-to="19855">
                        19855
                    </p>
                    <p class="beta-counter-title">
                        Clients Satisfied
                    </p>
                </div>
            </div>
            <div class="col-sm-2 col-sm-push-2">
                <div class="beta-counter">
                    ...
                    <p class="beta-counter-value timer numbers" data-speed="2000" data-to="3568">
                        3568
                    </p>
                    <p class="beta-counter-title">
                        Amazing Works
            ...
            <div class="col-sm-2 col-sm-push-2">
                <div class="beta-counter">
                    ...
                    <p class="beta-counter-value timer numbers" data-speed="2000" data-to="258934">
                        258934
                    </p>
                    <p class="beta-counter-title">
                        Support Hours
            ...
            <div class="col-sm-2 col-sm-push-2">
                <div class="beta-counter">
                    ...
                    <p class="beta-counter-value timer numbers" data-speed="2000" data-to="150">
                        150
                    </p>
                    <p class="beta-counter-title">
                        New Projects
        ...
        <!-- .beta-counter block end -->
        <div class="space50">
        </div>
        <hr/>
        <div class="space50">
        </div>
        <h2 class="text-center wow fadeInDownwow fadeInDown">
            Our Amaizing Team
        </h2>
        <div class="space20">
        </div>
        <h5 class="text-center other-title wow fadeInLeft">
            Founders
        </h5>
        <p class="text-center wow fadeInRight">
            Nemo enims voluptatem quia volupas sit aspe aut odit aut fugit, sed quia
            <br/>
        ...
        <div class="row">
            <div class="col-sm-6 wow fadeInLeft">
                <div class="beta-person media">
                    <img alt="" class="pull-left" src="source/assets/dest/images/person2.jpg">
                        <div class="media-body beta-person-body">
                            ...
                            <a href="single_type_gallery.html">
                                View projects
            ...
            <div class="col-sm-6 wow fadeInRight">
                <div class="beta-person media ">
                    <img alt="" class="pull-left" src="source/assets/dest/images/person3.jpg">
                        <div class="media-body beta-person-body">
                            <h5>
                                Mike Greenwood
                            </h5>
        ...
        <h5 class="text-center other-title wow fadeInDown">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img alt="" src="source/assets/dest/images/person1.jpg">
                        </img>
                    </div>
                    <div class="beta-person-body">
                        ...
                        <p>
                            Nemo enims voluptatem quia volupas sit aspe aut odit aut fugit, sed quia consequuntur magni dolores.
                        </p>
                        <a href="single_type_gallery.html">
                            View projects
                            <i class="fa fa-chevron-right">
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img alt="" src="source/assets/dest/images/person2.jpg">
                        </img>
                    </div>
                    <div class="beta-person-body">
                        <h5>
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img alt="" src="source/assets/dest/images/person3.jpg">
                        </img>
                    </div>
                    <div class="beta-person-body">
                        <h5>
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img alt="" src="source/assets/dest/images/person4.jpg">
                        </img>
                    </div>
                    <div class="beta-person-body">
                        <h5>
